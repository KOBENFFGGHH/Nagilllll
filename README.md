_G.Settings = {
	UI = {
        ...
        -- // Seting UI \\--
        ["Name"] = "Nagi",
        ["Top"] = "Map Legends of speed",
        ["Name Top"] = "Nagi Legends of speed",
		["Logo"] = 5553946656, --rbxassetid://5553946656
	},
}
...
LoadButton.Image = "http://www.roblox.com/asset/?id=".._G.Settings.UI["Logo"]
...
Title.Text = _G.Settings.UI["Name Top"]
Title.TextTransparency = 1
Title.TextColor3 = _G.Settings.UI["Color"]
	...
	LoadButton.MouseButton1Down:Connect(function()
		if LoadFocus == false then
			...
			repeat wait()
				...
				TitleLoad.Text = _G.Settings.UI["Top"]
				wait(0.35)
				TweenService:Create(
					TitleLoad,
					TweenInfo.new(.5, Enum.EasingStyle.Quart, Enum.EasingDirection.InOut),
				...
				TitleLoad.Text = _G.Settings.UI["Name"]
...
LoadScrollbar.MouseEnter:Connect(function()
	if LoadScrollbarFocus == false then
		TweenService:Create(
			LoadScrollbar,
			TweenInfo.new(.2, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut),
			{ImageColor3 = _G.Settings.UI["Color"]}
		):Play()
	end
end)
...
function Library.new()
	...
	function Library.Notifcation(options)
		...
		Button.BackgroundColor3 = _G.Settings.UI["Color"]
		...
		Line2.Name = "Line2"
		Line2.Parent = Line1
		Line2.BackgroundColor3 = _G.Settings.UI["Color"]
...
--https://discord.gg/mWyKB9GPbE
				...
				ButtonToggle.MouseButton1Down:Connect(function()
					...
					if visual.toggle == false and visual.lock == true then
						...
						TweenService:Create(
							Toggle_2,
							TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
							{BackgroundColor3 = _G.Settings.UI["Color"]}
						):Play()
						TweenService:Create(
							Toggle_2,
							TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
			...
			function LibraryFunction.Button(options)
				...
				ButtonFrame.BackgroundColor3 = _G.Settings.UI["Color"]
			...
			function LibraryFunction.Slider(options)
				...
				SliderValueFrame_2.BackgroundColor3 = _G.Settings.UI["Color"]
				...
				SliderValueFrame_3.BackgroundColor3 = _G.Settings.UI["Color"]
